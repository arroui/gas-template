...
class F<PROJECT_NAME>ValidationMessageGatherer : public FOutputDevice
{
public:
	F<PROJECT_NAME>ValidationMessageGatherer()
		: FOutputDevice()
	{
		GLog->AddOutputDevice(this);
	}

	virtual ~F<PROJECT_NAME>ValidationMessageGatherer()
	{
