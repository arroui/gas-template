...
#include "<PROJECT_NAME>PenetrationAvoidanceFeeler.generated.h"

/**
 * Struct defining a feeler ray used for camera penetration avoidance.
 */
USTRUCT()
struct F<PROJECT_NAME>PenetrationAvoidanceFeeler
{
	GENERATED_BODY()
	...
	F<PROJECT_NAME>PenetrationAvoidanceFeeler()
	...
	F<PROJECT_NAME>PenetrationAvoidanceFeeler(const FRotator& InAdjustmentRot,
