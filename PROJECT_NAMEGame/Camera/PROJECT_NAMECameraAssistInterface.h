...
#include "<PROJECT_NAME>CameraAssistInterface.generated.h"

/** */
UINTERFACE(BlueprintType)
class U<PROJECT_NAME>CameraAssistInterface : public UInterface
{
	GENERATED_BODY()
};

class I<PROJECT_NAME>CameraAssistInterface
{
	GENERATED_BODY()
