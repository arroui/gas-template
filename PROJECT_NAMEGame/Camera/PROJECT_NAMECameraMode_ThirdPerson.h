...
#include "<PROJECT_NAME>PenetrationAvoidanceFeeler.h"
#include "DrawDebugHelpers.h"
#include "<PROJECT_NAME>CameraMode_ThirdPerson.generated.h"

class UCurveVector;

/**
 * U<PROJECT_NAME>CameraMode_ThirdPerson
 *
 *	A basic third person camera mode.
 */
UCLASS(Abstract, Blueprintable)
class U<PROJECT_NAME>CameraMode_ThirdPerson : public U<PROJECT_NAME>CameraMode
{
	GENERATED_BODY()
...
public:
	...
	TArray<F<PROJECT_NAME>PenetrationAvoidanceFeeler> PenetrationAvoidanceFeelers;
