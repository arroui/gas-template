...
#include "<PROJECT_NAME>CharacterPartTypes.generated.h"
...
struct F<PROJECT_NAME>CharacterPartHandle
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct F<PROJECT_NAME>CharacterPart
{
	GENERATED_BODY()
	...
	static bool AreEquivalentParts(const F<PROJECT_NAME>CharacterPart& A, const F<PROJECT_NAME>CharacterPart& B)
	{
