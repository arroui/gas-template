...
/**
 * F<PROJECT_NAME>GameplayTags
 *
 *	Singleton containing native gameplay tags.
 */
struct F<PROJECT_NAME>GameplayTags
{
public:

	static const F<PROJECT_NAME>GameplayTags& Get() { return GameplayTags; }
...
private:
	...
	static F<PROJECT_NAME>GameplayTags GameplayTags;
};
