...
#include "<PROJECT_NAME>RangedWeaponInstance.generated.h"

class UPhysicalMaterial;

/**
 * U<PROJECT_NAME>RangedWeaponInstance
 *
 * A piece of equipment representing a ranged weapon spawned and applied to a pawn
 */
UCLASS()
class U<PROJECT_NAME>RangedWeaponInstance : public U<PROJECT_NAME>WeaponInstance, public I<PROJECT_NAME>AbilitySourceInterface
{
	GENERATED_BODY()

public:
	U<PROJECT_NAME>RangedWeaponInstance(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
...
public:
	...
	//~I<PROJECT_NAME>AbilitySourceInterface interface
	...
	//~End of I<PROJECT_NAME>AbilitySourceInterface interface
