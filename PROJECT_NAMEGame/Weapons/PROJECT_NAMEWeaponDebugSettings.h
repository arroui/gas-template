...
#include "<PROJECT_NAME>WeaponDebugSettings.generated.h"

/**
 * Developer debugging settings for weapons
 */
UCLASS(config=EditorPerProjectUserSettings)
class U<PROJECT_NAME>WeaponDebugSettings : public UDeveloperSettingsBackedByCVars
{
	GENERATED_BODY()

public:
	U<PROJECT_NAME>WeaponDebugSettings();
