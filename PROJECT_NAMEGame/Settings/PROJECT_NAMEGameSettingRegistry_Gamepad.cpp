...
UGameSettingCollection* U<PROJECT_NAME>GameSettingRegistry::InitializeGamepadSettings(U<PROJECT_NAME>LocalPlayer* InLocalPlayer)
{
	...
	////////////////////////////////////////////////////////////////////////////////////
	{
		...
		//----------------------------------------------------------------------------------
		{
			...
			if (UCommonInputPlatformSettings* PlatformInputSettings = UPlatformSettingsManager::Get().GetSettingsForPlatform<UCommonInputPlatformSettings>())
			{
				...
				if (Setting->GetDynamicOptions().Num() > 1 && PlatformInputSettings->CanChangeGamepadType())
				{
					...
					const FName CurrentControllerPlatform = GetDefault<U<PROJECT_NAME>SettingsLocal>()->GetControllerPlatform();
		...
		//----------------------------------------------------------------------------------
		{
			...
			Setting->SetDefaultValue(GetDefault<U<PROJECT_NAME>SettingsShared>()->GetForceFeedbackEnabled());
	...
	////////////////////////////////////////////////////////////////////////////////////
	{
		...
		//----------------------------------------------------------------------------------
		{
			...
			Setting->SetDefaultValue(GetDefault<U<PROJECT_NAME>SettingsShared>()->GetGamepadLookSensitivityPreset());

			for (int32 PresetIndex = 1; PresetIndex < (int32)E<PROJECT_NAME>GamepadSensitivity::MAX; PresetIndex++)
			{
				Setting->AddEnumOption(static_cast<E<PROJECT_NAME>GamepadSensitivity>(PresetIndex), EGamepadSensitivityText[PresetIndex]);
			}
		...
		//----------------------------------------------------------------------------------
		{
			...
			Setting->SetDefaultValue(GetDefault<U<PROJECT_NAME>SettingsShared>()->GetGamepadTargetingSensitivityPreset());
	...
	////////////////////////////////////////////////////////////////////////////////////
	{
		...
		//----------------------------------------------------------------------------------
		{
			...
			Setting->SetDefaultValue(GetDefault<U<PROJECT_NAME>SettingsShared>()->GetGamepadMoveStickDeadZone());
		...
		//----------------------------------------------------------------------------------
		{
			...
			Setting->SetDefaultValue(GetDefault<U<PROJECT_NAME>SettingsShared>()->GetGamepadLookStickDeadZone());
			Setting->SetDisplayFormat(UGameSettingValueScalarDynamic::ZeroToOnePercent);
			Setting->SetMinimumLimit(0.05);
			Setting->SetMaximumLimit(0.95);
