...
#include "<PROJECT_NAME>SafeZoneEditor.generated.h"
...
UCLASS(Abstract)
class U<PROJECT_NAME>SafeZoneEditor : public UCommonActivatableWidget, public IGameSettingActionInterface
{
	GENERATED_BODY()
...
public:
	U<PROJECT_NAME>SafeZoneEditor(const FObjectInitializer& Initializer);
