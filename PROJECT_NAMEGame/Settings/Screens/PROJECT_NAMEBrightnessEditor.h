...
#include "<PROJECT_NAME>BrightnessEditor.generated.h"
...
UCLASS(Abstract)
class U<PROJECT_NAME>BrightnessEditor : public UCommonActivatableWidget, public IGameSettingActionInterface
{
	GENERATED_BODY()
...
public:
	U<PROJECT_NAME>BrightnessEditor(const FObjectInitializer& Initializer);
