...
#include "CustomSettings/<PROJECT_NAME>SettingValueDiscrete_PerfStat.h"

#define LOCTEXT_NAMESPACE "<PROJECT_NAME>"

//////////////////////////////////////////////////////////////////////

void U<PROJECT_NAME>GameSettingRegistry::AddPerformanceStatPage(UGameSettingCollection* PerfStatsOuterCategory, U<PROJECT_NAME>LocalPlayer* InLocalPlayer)
{
	//----------------------------------------------------------------------------------
	{
		static_assert((int32)E<PROJECT_NAME>DisplayablePerformanceStat::Count == 15, "Consider updating this function to deal with new performance stats");
		...
		////////////////////////////////////////////////////////////////////////////////////
		{
			...
			//----------------------------------------------------------------------------------
			{
				U<PROJECT_NAME>SettingValueDiscrete_PerfStat* Setting = NewObject<U<PROJECT_NAME>SettingValueDiscrete_PerfStat>();
				Setting->SetStat(E<PROJECT_NAME>DisplayablePerformanceStat::ClientFPS);
			...
			{
				U<PROJECT_NAME>SettingValueDiscrete_PerfStat* Setting = NewObject<U<PROJECT_NAME>SettingValueDiscrete_PerfStat>();
				Setting->SetStat(E<PROJECT_NAME>DisplayablePerformanceStat::ServerFPS);
			...
			{
				U<PROJECT_NAME>SettingValueDiscrete_PerfStat* Setting = NewObject<U<PROJECT_NAME>SettingValueDiscrete_PerfStat>();
				Setting->SetStat(E<PROJECT_NAME>DisplayablePerformanceStat::FrameTime);
			...
			{
				U<PROJECT_NAME>SettingValueDiscrete_PerfStat* Setting = NewObject<U<PROJECT_NAME>SettingValueDiscrete_PerfStat>();
				Setting->SetStat(E<PROJECT_NAME>DisplayablePerformanceStat::IdleTime);
			...
			{
				U<PROJECT_NAME>SettingValueDiscrete_PerfStat* Setting = NewObject<U<PROJECT_NAME>SettingValueDiscrete_PerfStat>();
				Setting->SetStat(E<PROJECT_NAME>DisplayablePerformanceStat::FrameTime_GameThread);
			...
			{
				U<PROJECT_NAME>SettingValueDiscrete_PerfStat* Setting = NewObject<U<PROJECT_NAME>SettingValueDiscrete_PerfStat>();
				Setting->SetStat(E<PROJECT_NAME>DisplayablePerformanceStat::FrameTime_RenderThread);
			...
			{
				U<PROJECT_NAME>SettingValueDiscrete_PerfStat* Setting = NewObject<U<PROJECT_NAME>SettingValueDiscrete_PerfStat>();
				Setting->SetStat(E<PROJECT_NAME>DisplayablePerformanceStat::FrameTime_RHIThread);
			...
			{
				U<PROJECT_NAME>SettingValueDiscrete_PerfStat* Setting = NewObject<U<PROJECT_NAME>SettingValueDiscrete_PerfStat>();
				Setting->SetStat(E<PROJECT_NAME>DisplayablePerformanceStat::FrameTime_GPU);
		...
		////////////////////////////////////////////////////////////////////////////////////
		{
			...
			{
				U<PROJECT_NAME>SettingValueDiscrete_PerfStat* Setting = NewObject<U<PROJECT_NAME>SettingValueDiscrete_PerfStat>();
				Setting->SetStat(E<PROJECT_NAME>DisplayablePerformanceStat::Ping);
			...
			{
				U<PROJECT_NAME>SettingValueDiscrete_PerfStat* Setting = NewObject<U<PROJECT_NAME>SettingValueDiscrete_PerfStat>();
				Setting->SetStat(E<PROJECT_NAME>DisplayablePerformanceStat::PacketLoss_Incoming);
			...
			{
				U<PROJECT_NAME>SettingValueDiscrete_PerfStat* Setting = NewObject<U<PROJECT_NAME>SettingValueDiscrete_PerfStat>();
				Setting->SetStat(E<PROJECT_NAME>DisplayablePerformanceStat::PacketLoss_Outgoing);
			...
			{
				U<PROJECT_NAME>SettingValueDiscrete_PerfStat* Setting = NewObject<U<PROJECT_NAME>SettingValueDiscrete_PerfStat>();
				Setting->SetStat(E<PROJECT_NAME>DisplayablePerformanceStat::PacketRate_Incoming);
			...
			{
				U<PROJECT_NAME>SettingValueDiscrete_PerfStat* Setting = NewObject<U<PROJECT_NAME>SettingValueDiscrete_PerfStat>();
				Setting->SetStat(E<PROJECT_NAME>DisplayablePerformanceStat::PacketRate_Outgoing);
			...
			{
				U<PROJECT_NAME>SettingValueDiscrete_PerfStat* Setting = NewObject<U<PROJECT_NAME>SettingValueDiscrete_PerfStat>();
				Setting->SetStat(E<PROJECT_NAME>DisplayablePerformanceStat::PacketSize_Incoming);
			...
			{
				U<PROJECT_NAME>SettingValueDiscrete_PerfStat* Setting = NewObject<U<PROJECT_NAME>SettingValueDiscrete_PerfStat>();
				Setting->SetStat(E<PROJECT_NAME>DisplayablePerformanceStat::PacketSize_Outgoing);
