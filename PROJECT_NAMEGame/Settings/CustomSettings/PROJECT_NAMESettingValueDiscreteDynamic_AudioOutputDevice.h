...
#include "<PROJECT_NAME>SettingValueDiscreteDynamic_AudioOutputDevice.generated.h"

enum class EAudioDeviceChangedRole : uint8;

UCLASS()
class U<PROJECT_NAME>SettingValueDiscreteDynamic_AudioOutputDevice : public UGameSettingValueDiscreteDynamic
{
	GENERATED_BODY()
	
public:

	virtual ~U<PROJECT_NAME>SettingValueDiscreteDynamic_AudioOutputDevice() = default;
