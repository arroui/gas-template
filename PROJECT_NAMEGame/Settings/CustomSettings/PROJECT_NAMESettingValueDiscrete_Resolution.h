...
#include "<PROJECT_NAME>SettingValueDiscrete_Resolution.generated.h"

struct FScreenResolutionRHI;

UCLASS()
class U<PROJECT_NAME>SettingValueDiscrete_Resolution : public UGameSettingValueDiscrete
{
	GENERATED_BODY()
	
public:

	U<PROJECT_NAME>SettingValueDiscrete_Resolution();
