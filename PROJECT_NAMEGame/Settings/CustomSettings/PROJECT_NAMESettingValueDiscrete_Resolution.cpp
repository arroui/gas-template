...
#include "<PROJECT_NAME>SettingValueDiscrete_Resolution.h"
...
U<PROJECT_NAME>SettingValueDiscrete_Resolution::U<PROJECT_NAME>SettingValueDiscrete_Resolution()
{
}

void U<PROJECT_NAME>SettingValueDiscrete_Resolution::OnInitialized()
{
	Super::OnInitialized();
...
void U<PROJECT_NAME>SettingValueDiscrete_Resolution::StoreInitial()
{
	// Ignored
}

void U<PROJECT_NAME>SettingValueDiscrete_Resolution::ResetToDefault()
{
	// Ignored
}

void U<PROJECT_NAME>SettingValueDiscrete_Resolution::RestoreToInitial()
{
	// Ignored
}

void U<PROJECT_NAME>SettingValueDiscrete_Resolution::SetDiscreteOptionByIndex(int32 Index)
{
...
int32 U<PROJECT_NAME>SettingValueDiscrete_Resolution::GetDiscreteOptionIndex() const
{
...
TArray<FText> U<PROJECT_NAME>SettingValueDiscrete_Resolution::GetDiscreteOptions() const
{
...
void U<PROJECT_NAME>SettingValueDiscrete_Resolution::OnDependencyChanged()
{
...
void U<PROJECT_NAME>SettingValueDiscrete_Resolution::InitializeResolutions()
{
	Resolutions.Empty();
...
void U<PROJECT_NAME>SettingValueDiscrete_Resolution::SelectAppropriateResolutions()
{
...
bool U<PROJECT_NAME>SettingValueDiscrete_Resolution::ShouldAllowFullScreenResolution(const FScreenResolutionRHI& SrcScreenRes, int32 FilterThreshold) const
{
...
int32 U<PROJECT_NAME>SettingValueDiscrete_Resolution::FindIndexOfDisplayResolution(const FIntPoint& InPoint) const
{
...
int32 U<PROJECT_NAME>SettingValueDiscrete_Resolution::FindIndexOfDisplayResolutionForceValid(const FIntPoint& InPoint) const
{
...
int32 U<PROJECT_NAME>SettingValueDiscrete_Resolution::FindClosestResolutionIndex(const FIntPoint& Resolution) const
{	
	int32 Index = 0;
...
void U<PROJECT_NAME>SettingValueDiscrete_Resolution::GetStandardWindowResolutions(const FIntPoint& MinResolution, const FIntPoint& MaxResolution, float MinAspectRatio, TArray<FIntPoint>& OutResolutions)
{
...
FText U<PROJECT_NAME>SettingValueDiscrete_Resolution::FScreenResolutionEntry::GetDisplayText() const
{
