...
#include "<PROJECT_NAME>SettingsLocal.generated.h"
...
USTRUCT()
struct F<PROJECT_NAME>ScalabilitySnapshot
{
	GENERATED_BODY()

	F<PROJECT_NAME>ScalabilitySnapshot();
...
/**
 * U<PROJECT_NAME>SettingsLocal
 */
UCLASS()
class U<PROJECT_NAME>SettingsLocal : public UGameUserSettings
{
	GENERATED_BODY()
...
public:
	...
	static U<PROJECT_NAME>SettingsLocal* Get();
...
public:
	...
	E<PROJECT_NAME>StatDisplayMode GetPerfStatDisplayState(E<PROJECT_NAME>DisplayablePerformanceStat Stat) const;
	
	/** Sets the display mode for the specified performance stat */
	void SetPerfStatDisplayState(E<PROJECT_NAME>DisplayablePerformanceStat Stat, E<PROJECT_NAME>StatDisplayMode DisplayMode);

	/** Fired when the display state for a performance stat has changed, or the settings are applied */
	DECLARE_EVENT(U<PROJECT_NAME>SettingsLocal, FPerfStatSettingsChanged);
...
private:
	...
	UPROPERTY(Config)
	TMap<E<PROJECT_NAME>DisplayablePerformanceStat, E<PROJECT_NAME>StatDisplayMode> DisplayStatList;
...
private:
	...
	void OverrideQualityLevelsToScalabilityMode(const F<PROJECT_NAME>ScalabilitySnapshot& InMode, Scalability::FQualityLevels& InOutLevels);
...
private:
	...
	F<PROJECT_NAME>ScalabilitySnapshot DeviceDefaultScalabilitySettings;
...
private:
	...
	// Audio - Volume
public:
	DECLARE_EVENT_OneParam(U<PROJECT_NAME>SettingsLocal, FAudioDeviceChanged, const FString& /*DeviceId*/);
...
public:
	...
	DECLARE_EVENT_OneParam(U<PROJECT_NAME>SettingsLocal, FInputConfigDelegate, const FLoadedMappableConfigPair& /*Config*/);
	 ...
	 */
	void AddOrUpdateCustomKeyboardBindings(const FName MappingName, const FKey NewKey, U<PROJECT_NAME>LocalPlayer* LocalPlayer);
