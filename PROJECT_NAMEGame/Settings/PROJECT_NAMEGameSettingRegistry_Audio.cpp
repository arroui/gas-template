...
#include "CustomSettings/<PROJECT_NAME>SettingValueDiscreteDynamic_AudioOutputDevice.h"
...
UGameSettingCollection* U<PROJECT_NAME>GameSettingRegistry::InitializeAudioSettings(U<PROJECT_NAME>LocalPlayer* InLocalPlayer)
{
	...
	////////////////////////////////////////////////////////////////////////////////////
	{
		...
		//----------------------------------------------------------------------------------
		{
			...
			Setting->SetDefaultValue(GetDefault<U<PROJECT_NAME>SettingsLocal>()->GetOverallVolume());
		...
		//----------------------------------------------------------------------------------
		{
			...
			Setting->SetDefaultValue(GetDefault<U<PROJECT_NAME>SettingsLocal>()->GetMusicVolume());
			Setting->SetDisplayFormat(UGameSettingValueScalarDynamic::ZeroToOnePercent);
		...
		//----------------------------------------------------------------------------------
		{
			...
			Setting->SetDefaultValue(GetDefault<U<PROJECT_NAME>SettingsLocal>()->GetSoundFXVolume());
			Setting->SetDisplayFormat(UGameSettingValueScalarDynamic::ZeroToOnePercent);
		...
		//----------------------------------------------------------------------------------
		{
			...
			Setting->SetDefaultValue(GetDefault<U<PROJECT_NAME>SettingsLocal>()->GetDialogueVolume());
			Setting->SetDisplayFormat(UGameSettingValueScalarDynamic::ZeroToOnePercent);
		...
		//----------------------------------------------------------------------------------
		{
			...
			Setting->SetDefaultValue(GetDefault<U<PROJECT_NAME>SettingsLocal>()->GetVoiceChatVolume());
			Setting->SetDisplayFormat(UGameSettingValueScalarDynamic::ZeroToOnePercent);
	...
	////////////////////////////////////////////////////////////////////////////////////
	{
		...
		//----------------------------------------------------------------------------------
		{
			...
			////////////////////////////////////////////////////////////////////////////////////
			{
				...
				//----------------------------------------------------------------------------------
				{
					...
					Setting->SetDefaultValue(GetDefault<U<PROJECT_NAME>SettingsShared>()->GetSubtitlesEnabled());
				...
				//----------------------------------------------------------------------------------
				{
					...
					Setting->SetDefaultValue(GetDefault<U<PROJECT_NAME>SettingsShared>()->GetSubtitlesTextSize());
				...
				//----------------------------------------------------------------------------------
				{
					...
					Setting->SetDefaultValue(GetDefault<U<PROJECT_NAME>SettingsShared>()->GetSubtitlesTextColor());
				...
				//----------------------------------------------------------------------------------
				{
					...
					Setting->SetDefaultValue(GetDefault<U<PROJECT_NAME>SettingsShared>()->GetSubtitlesTextBorder());
				...
				//----------------------------------------------------------------------------------
				{
					...
					Setting->SetDefaultValue(GetDefault<U<PROJECT_NAME>SettingsShared>()->GetSubtitlesBackgroundOpacity());
		...
		//----------------------------------------------------------------------------------
		{
			U<PROJECT_NAME>SettingValueDiscreteDynamic_AudioOutputDevice* Setting = NewObject<U<PROJECT_NAME>SettingValueDiscreteDynamic_AudioOutputDevice>();
		...
		//----------------------------------------------------------------------------------
		{
			...
			Setting->SetDefaultValue(GetDefault<U<PROJECT_NAME>SettingsShared>()->GetAllowAudioInBackgroundSetting());

			Setting->AddEnumOption(E<PROJECT_NAME>AllowBackgroundAudioSetting::Off, LOCTEXT("E<PROJECT_NAME>AllowBackgroundAudioSetting_Off", "Off"));
			Setting->AddEnumOption(E<PROJECT_NAME>AllowBackgroundAudioSetting::AllSounds, LOCTEXT("E<PROJECT_NAME>AllowBackgroundAudioSetting_AllSounds", "All Sounds"));
		...
		//----------------------------------------------------------------------------------
		{
			...
			Setting->SetDefaultValue(GetDefault<U<PROJECT_NAME>SettingsLocal>()->IsHeadphoneModeEnabled());

			Setting->AddEditCondition(MakeShared<FWhenCondition>(
				[](const ULocalPlayer*, FGameSettingEditableState& InOutEditState)
				{
					if (!GetDefault<U<PROJECT_NAME>SettingsLocal>()->CanModifyHeadphoneModeEnabled())
					{
		...
		//----------------------------------------------------------------------------------
		{
			...
			Setting->SetDefaultValue(GetDefault<U<PROJECT_NAME>SettingsLocal>()->IsHDRAudioModeEnabled());
