...
#include "<PROJECT_NAME>TaggedWidget.generated.h"

/**
 * An widget in a layout that has been tagged (can be hidden or shown via tags on the owning player)
 */
UCLASS(Abstract, Blueprintable)
class U<PROJECT_NAME>TaggedWidget : public UCommonUserWidget
{
	GENERATED_BODY()

public:
	U<PROJECT_NAME>TaggedWidget(const FObjectInitializer& ObjectInitializer);
