...
void UIndicatorDescriptor::SetIndicatorManagerComponent(U<PROJECT_NAME>IndicatorManagerComponent* InManager)
{
...
{
	if (U<PROJECT_NAME>IndicatorManagerComponent* Manager = ManagerPtr.Get())
	{
