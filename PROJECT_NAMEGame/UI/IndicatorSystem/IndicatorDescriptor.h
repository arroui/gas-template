...
class <PROJECT_NAME_UPPER>GAME_API UIndicatorDescriptor : public UObject
{
	GENERATED_BODY()
...
public:
	U<PROJECT_NAME>IndicatorManagerComponent* GetIndicatorManagerComponent() { return ManagerPtr.Get(); }
	void SetIndicatorManagerComponent(U<PROJECT_NAME>IndicatorManagerComponent* InManager);
...
private:
	...
	UPROPERTY()
	TWeakObjectPtr<U<PROJECT_NAME>IndicatorManagerComponent> ManagerPtr;
