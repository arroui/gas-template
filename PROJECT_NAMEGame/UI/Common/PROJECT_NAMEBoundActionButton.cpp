...
#include "<PROJECT_NAME>BoundActionButton.h"
#include "CommonInputSubsystem.h"

void U<PROJECT_NAME>BoundActionButton::NativeConstruct()
{
...
void U<PROJECT_NAME>BoundActionButton::HandleInputMethodChanged(ECommonInputType NewInputMethod)
{
