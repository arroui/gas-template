...
#include "<PROJECT_NAME>JoystickWidget.generated.h"
 ...
 */
UCLASS(meta=( DisplayName="<PROJECT_NAME> Joystick" ))
class <PROJECT_NAME_UPPER>GAME_API U<PROJECT_NAME>JoystickWidget : public U<PROJECT_NAME>SimulatedInputWidget
{
	GENERATED_BODY()
	
public:
	
	U<PROJECT_NAME>JoystickWidget(const FObjectInitializer& ObjectInitializer);
