...
#include "<PROJECT_NAME>SimulatedInputWidget.generated.h"
 ...
 */
UCLASS(meta=( DisplayName="<PROJECT_NAME> Simulated Input Widget" ))
class <PROJECT_NAME_UPPER>GAME_API U<PROJECT_NAME>SimulatedInputWidget : public UCommonUserWidget
{
	GENERATED_BODY()
	
public:
	
	U<PROJECT_NAME>SimulatedInputWidget(const FObjectInitializer& ObjectInitializer);
