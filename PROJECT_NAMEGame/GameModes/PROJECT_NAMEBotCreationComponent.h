...
#include "<PROJECT_NAME>BotCreationComponent.generated.h"
...
class U<PROJECT_NAME>BotCreationComponent : public UGameStateComponent
{
	GENERATED_BODY()

public:
	U<PROJECT_NAME>BotCreationComponent(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
