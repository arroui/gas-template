...
class A<PROJECT_NAME>GameMode : public AModularGameModeBase
{
	GENERATED_BODY()

public:

	A<PROJECT_NAME>GameMode(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());

	const U<PROJECT_NAME>PawnData* GetPawnDataForController(const AController* InController) const;
