...
#include "<PROJECT_NAME>UserFacingExperienceDefinition.generated.h"
...
class U<PROJECT_NAME>UserFacingExperienceDefinition : public UPrimaryDataAsset
{
	GENERATED_BODY()
...
public:
	...
	UPROPERTY(BlueprintReadWrite, EditAnywhere, Category=Experience, meta=(AllowedTypes="<PROJECT_NAME>ExperienceDefinition"))
