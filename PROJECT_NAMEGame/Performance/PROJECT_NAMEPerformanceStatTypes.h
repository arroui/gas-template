...
#include "<PROJECT_NAME>PerformanceStatTypes.generated.h"

//////////////////////////////////////////////////////////////////////

// Way to display the stat
UENUM(BlueprintType)
enum class E<PROJECT_NAME>StatDisplayMode : uint8
{
...
UENUM(BlueprintType)
enum class E<PROJECT_NAME>DisplayablePerformanceStat : uint8
{
	// stat fps (in Hz)
	ClientFPS,
...
ENUM_RANGE_BY_COUNT(E<PROJECT_NAME>DisplayablePerformanceStat, E<PROJECT_NAME>DisplayablePerformanceStat::Count);
