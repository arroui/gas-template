...
#include "<PROJECT_NAME>GameplayAbility_Interact.h"
...
#include "UI/IndicatorSystem/<PROJECT_NAME>IndicatorManagerComponent.h"
...
U<PROJECT_NAME>GameplayAbility_Interact::U<PROJECT_NAME>GameplayAbility_Interact(const FObjectInitializer& ObjectInitializer)
	: Super(ObjectInitializer)
{
	ActivationPolicy = E<PROJECT_NAME>AbilityActivationPolicy::OnSpawn;
	InstancingPolicy = EGameplayAbilityInstancingPolicy::InstancedPerActor;
	NetExecutionPolicy = EGameplayAbilityNetExecutionPolicy::LocalPredicted;
}

void U<PROJECT_NAME>GameplayAbility_Interact::ActivateAbility(const FGameplayAbilitySpecHandle Handle, const FGameplayAbilityActorInfo* ActorInfo, const FGameplayAbilityActivationInfo ActivationInfo, const FGameplayEventData* TriggerEventData)
{
...
void U<PROJECT_NAME>GameplayAbility_Interact::UpdateInteractions(const TArray<FInteractionOption>& InteractiveOptions)
{
	if (A<PROJECT_NAME>PlayerController* PC = Get<PROJECT_NAME>PlayerControllerFromActorInfo())
	{
		if (U<PROJECT_NAME>IndicatorManagerComponent* IndicatorManager = U<PROJECT_NAME>IndicatorManagerComponent::GetComponent(PC))
		{
...
void U<PROJECT_NAME>GameplayAbility_Interact::TriggerInteraction()
{
