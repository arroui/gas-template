...
struct F<PROJECT_NAME>AbilityGrant
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct F<PROJECT_NAME>AttributeSetGrant
{
	GENERATED_BODY()
...
struct FGameFeatureAbilitiesEntry
{
	...
	UPROPERTY(EditAnywhere, Category="Abilities")
	TArray<F<PROJECT_NAME>AbilityGrant> GrantedAbilities;

	// List of attribute sets to grant to actors of the specified class 
	UPROPERTY(EditAnywhere, Category="Attributes")
	TArray<F<PROJECT_NAME>AttributeSetGrant> GrantedAttributes;

	// List of ability sets to grant to actors of the specified class
	UPROPERTY(EditAnywhere, Category="Attributes", meta=(AssetBundles="Client,Server"))
	TArray<TSoftObjectPtr<const U<PROJECT_NAME>AbilitySet>> GrantedAbilitySets;
};
...
private:
	struct FActorExtensions
	{
		...
		TArray<F<PROJECT_NAME>AbilitySet_GrantedHandles> AbilitySetHandles;
	};
