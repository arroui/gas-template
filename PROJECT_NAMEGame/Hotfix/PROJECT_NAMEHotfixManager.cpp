...
#include "<PROJECT_NAME>HotfixManager.h"
#include "Misc/AES.h"
...
int32 U<PROJECT_NAME>HotfixManager::GameHotfixCounter = 0;

U<PROJECT_NAME>HotfixManager::U<PROJECT_NAME>HotfixManager()
{
#if !UE_BUILD_SHIPPING
	OnScreenMessageHandle = FCoreDelegates::OnGetOnScreenMessages.AddUObject(this, &U<PROJECT_NAME>HotfixManager::GetOnScreenMessages);
...
void U<PROJECT_NAME>HotfixManager::Init()
{
	Super::Init();
}

void U<PROJECT_NAME>HotfixManager::OnHotfixCompleted(EHotfixResult HotfixResult)
{
	...
	if (bHasPendingDeviceProfileHotfix)
	{
		...
		U<PROJECT_NAME>SettingsLocal* GameSettings = U<PROJECT_NAME>SettingsLocal::Get();
...
bool U<PROJECT_NAME>HotfixManager::WantsHotfixProcessing(const FCloudFileHeader& FileHeader)
{
...
bool U<PROJECT_NAME>HotfixManager::HotfixIniFile(const FString& FileName, const FString& IniData)
{
...
bool U<PROJECT_NAME>HotfixManager::ApplyHotfixProcessing(const FCloudFileHeader& FileHeader)
{
...
bool U<PROJECT_NAME>HotfixManager::ShouldWarnAboutMissingWhenPatchingFromIni(const FString& AssetPath) const
{
	return AssetPath.StartsWith(TEXT("/Engine/")) || AssetPath.StartsWith(TEXT("/Game/"));
}

void U<PROJECT_NAME>HotfixManager::PatchAssetsFromIniFiles()
{
#if ENABLE_SHARED_MEMORY_TRACKER
...
void U<PROJECT_NAME>HotfixManager::OnHotfixAvailablityCheck(const TArray<FCloudFileHeader>& PendingChangedFiles, const TArray<FCloudFileHeader>& PendingRemoveFiles)
{
...
bool U<PROJECT_NAME>HotfixManager::PreProcessDownloadedFileData(TArray<uint8>& FileData) const
{
...
#if !UE_BUILD_SHIPPING
void U<PROJECT_NAME>HotfixManager::GetOnScreenMessages(TMultiMap<FCoreDelegates::EOnScreenMessageSeverity, FText>& OutMessages)
{
	// TODO Any messages/errors.
}
#endif // !UE_BUILD_SHIPPING

void U<PROJECT_NAME>HotfixManager::RequestPatchAssetsFromIniFiles()
{
...
void U<PROJECT_NAME>HotfixManager::StartHotfixProcess()
{
	if (GIsEditor)
	{
