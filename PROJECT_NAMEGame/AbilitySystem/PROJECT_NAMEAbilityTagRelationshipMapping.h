...
#include "<PROJECT_NAME>AbilityTagRelationshipMapping.generated.h"

/** Struct that defines the relationship between different ability tags */
USTRUCT()
struct F<PROJECT_NAME>AbilityTagRelationship
{
	GENERATED_BODY()
...
UCLASS()
class U<PROJECT_NAME>AbilityTagRelationshipMapping : public UDataAsset
{
	GENERATED_BODY()
...
private:
	...
	TArray<F<PROJECT_NAME>AbilityTagRelationship> AbilityTagRelationships;
