...
#include "<PROJECT_NAME>AbilityCost.generated.h"

class U<PROJECT_NAME>GameplayAbility;

/**
 * U<PROJECT_NAME>AbilityCost
 *
 * Base class for costs that a <PROJECT_NAME>GameplayAbility has (e.g., ammo or charges)
 */
UCLASS(DefaultToInstanced, EditInlineNew, Abstract)
class U<PROJECT_NAME>AbilityCost : public UObject
{
	GENERATED_BODY()
...
public:
	 ...
	 */
	virtual bool CheckCost(const U<PROJECT_NAME>GameplayAbility* Ability, const FGameplayAbilitySpecHandle Handle, const FGameplayAbilityActorInfo* ActorInfo, FGameplayTagContainer* OptionalRelevantTags) const
	{
		return true;
	}
	 ...
	 */
	virtual void ApplyCost(const U<PROJECT_NAME>GameplayAbility* Ability, const FGameplayAbilitySpecHandle Handle, const FGameplayAbilityActorInfo* ActorInfo, const FGameplayAbilityActivationInfo ActivationInfo)
	{
	}
