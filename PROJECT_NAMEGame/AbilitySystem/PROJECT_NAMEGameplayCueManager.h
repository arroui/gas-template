...
#include "<PROJECT_NAME>GameplayCueManager.generated.h"

/**
 * U<PROJECT_NAME>GameplayCueManager
 *
 * Game-specific manager for gameplay cues
 */
UCLASS()
class U<PROJECT_NAME>GameplayCueManager : public UGameplayCueManager
{
	GENERATED_BODY()

public:
	U<PROJECT_NAME>GameplayCueManager(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());

	static U<PROJECT_NAME>GameplayCueManager* Get();
