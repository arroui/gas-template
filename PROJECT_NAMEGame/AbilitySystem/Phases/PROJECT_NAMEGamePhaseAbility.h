...
#include "<PROJECT_NAME>GamePhaseAbility.generated.h"

/**
 * U<PROJECT_NAME>GamePhaseAbility
 *
 * The base gameplay ability for any ability that is used to change the active game phase.
 */
UCLASS(Abstract, HideCategories = Input)
class U<PROJECT_NAME>GamePhaseAbility : public U<PROJECT_NAME>GameplayAbility
{
	GENERATED_BODY()

public:

	U<PROJECT_NAME>GamePhaseAbility(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
...
protected:
	...
	UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, Category = "<PROJECT_NAME>|Game Phase")
