...
#include "<PROJECT_NAME>SystemStatics.generated.h"

class UMeshComponent;

UCLASS()
class U<PROJECT_NAME>SystemStatics : public UBlueprintFunctionLibrary
{
	GENERATED_BODY()
...
public:
	...
	UFUNCTION(BlueprintCallable, BlueprintAuthorityOnly, Category="<PROJECT_NAME>", meta = (WorldContext = "WorldContextObject"))
