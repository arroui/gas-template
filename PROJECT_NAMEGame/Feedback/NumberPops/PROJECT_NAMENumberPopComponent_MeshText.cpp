...
#include "<PROJECT_NAME>NumberPopComponent_MeshText.h"
#include "TimerManager.h"
#include "Components/StaticMeshComponent.h"
#include "Engine/CollisionProfile.h"
#include "Materials/MaterialInstanceDynamic.h"
#include "Camera/PlayerCameraManager.h"
#include "<PROJECT_NAME>DamagePopStyle.h"

U<PROJECT_NAME>NumberPopComponent_MeshText::U<PROJECT_NAME>NumberPopComponent_MeshText(const FObjectInitializer& ObjectInitializer)
...
void U<PROJECT_NAME>NumberPopComponent_MeshText::AddNumberPop(const F<PROJECT_NAME>NumberPopRequest& NewRequest)
{
...
void U<PROJECT_NAME>NumberPopComponent_MeshText::ReleaseNextComponents()
{
	UWorld* LocalWorld = GetWorld();
	check(LocalWorld);
...
FLinearColor U<PROJECT_NAME>NumberPopComponent_MeshText::DetermineColor(const F<PROJECT_NAME>NumberPopRequest& Request) const
{
	for (U<PROJECT_NAME>DamagePopStyle* Style : Styles)
	{
...
UStaticMesh* U<PROJECT_NAME>NumberPopComponent_MeshText::DetermineStaticMesh(const F<PROJECT_NAME>NumberPopRequest& Request) const
{
	for (U<PROJECT_NAME>DamagePopStyle* Style : Styles)
	{
...
void U<PROJECT_NAME>NumberPopComponent_MeshText::SetMaterialParameters(const F<PROJECT_NAME>NumberPopRequest& Request, FTempNumberPopInfo& NewDamageNumberInfo, const FTransform& CameraTransform, const FVector& NumberLocation)
{
